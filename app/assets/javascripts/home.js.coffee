...
display_nonoptimal_browser_message = ->
	content = $("<div class='modal-message'><p>For best experience, please view on a desktop version of a modern browser.</p><p class='center'>Click Anywhere To Continue</p></div>")
