...
PostElement.create(post: p, element: tb, sequence: 2, position: "fixed-top:30px;fluid-h:50%") #, animation_type: 'scan', animation_direction: 'left')
...
tb = TextBox.create(style: 'full-margins',
                    text: %{
<p class="large">Press: <a href="mailto:press@svmg.tw">press@svmg.com</a><br />Business: <a href="mailto:business@svmg.tw">business@svmg.com</a></p>
},
                    text_align: "center")
PostElement.create(post: p, element: tb, sequence: 2, position: "fluid-h:50%;fixed-top:450px;", animation_type: "fixed")
